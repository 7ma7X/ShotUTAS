...
module.exports = class {
    ...
    static async takeShot (num, rows, browser) {
        ...
        await element.screenshot({path: path.join(`${subject}`, `${subject}_pic1.png`)});
        ...
        await element2.screenshot({path: path.join(`${subject}`, `${subject}_pic2.png`)});
